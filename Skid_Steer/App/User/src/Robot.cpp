...
Robot::Robot(RobotParams& params):
     ...
     batVolt(params.voltageSensorHandle, params.votlageSensorM, params.voltageSensorC),
     currentSensor(params.currentSensorHandle, params.currentSensorM, params.currentSensorC),
     refV(params.refV),
